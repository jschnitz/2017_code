...
AddOutputFilter chunkFilter
		...
		<Item Name="NavX Main.vi" Type="VI" URL="../navX Library v2/NavX Main.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="CustomPID_v2.1.vi" Type="VI" URL="../CustomPID_v2.1.vi"/>
			<Item Name="FRC_NetworkCommunication.dll" Type="Document" URL="FRC_NetworkCommunication.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="FRIC_navX_Clear_Buffer_Warning.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Clear_Buffer_Warning.vi"/>
			<Item Name="FRIC_navX_DecodeRegisterLengthClusterTypeDef_.ctl" Type="VI" URL="../navX Library v2/TypeDefs/FRIC_navX_DecodeRegisterLengthClusterTypeDef_.ctl"/>
			<Item Name="FRIC_navX_DeviceNumbersTypeDef.ctl" Type="VI" URL="../navX Library v2/TypeDefs/FRIC_navX_DeviceNumbersTypeDef.ctl"/>
			<Item Name="FRIC_navX_Get_NextState_ProcessLoop.vi" Type="VI" URL="../navX Library v2/Get/FRIC_navX_Get_NextState_ProcessLoop.vi"/>
			<Item Name="FRIC_navX_Get_Registry.vi" Type="VI" URL="../navX Library v2/Get/Raw Values/FRIC_navX_Get_Registry.vi"/>
			<Item Name="FRIC_navX_I2C Process Loop TypeDef.ctl" Type="VI" URL="../navX Library v2/TypeDefs/FRIC_navX_I2C Process Loop TypeDef.ctl"/>
			<Item Name="FRIC_navX_Internal_I2C_GenerateCommand.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_I2C_GenerateCommand.vi"/>
			<Item Name="FRIC_navX_Internal_I2C_ProcessingLoop.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_I2C_ProcessingLoop.vi"/>
			<Item Name="FRIC_navX_Internal_ProcessingLoop_AddToArray.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_ProcessingLoop_AddToArray.vi"/>
			<Item Name="FRIC_navX_Internal_ProcessingLoop_UpdateAE.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_ProcessingLoop_UpdateAE.vi"/>
			<Item Name="FRIC_navX_Internal_Serial_GenerateCommand.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_Serial_GenerateCommand.vi"/>
			<Item Name="FRIC_navX_Internal_Serial_ProcessingLoop.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_Serial_ProcessingLoop.vi"/>
			<Item Name="FRIC_navX_Internal_SPI_GenerateCommand.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_SPI_GenerateCommand.vi"/>
			<Item Name="FRIC_navX_Internal_SPI_ProcessingLoop.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_SPI_ProcessingLoop.vi"/>
			<Item Name="FRIC_navX_Internal_USB_ProcessingLoop.vi" Type="VI" URL="../navX Library v2/_Processing Loop/FRIC_navX_Internal_USB_ProcessingLoop.vi"/>
			<Item Name="FRIC_navX_ProcessingLoopStatesTypeDef_I2C.ctl" Type="VI" URL="../navX Library v2/TypeDefs/FRIC_navX_ProcessingLoopStatesTypeDef_I2C.ctl"/>
			<Item Name="Get_BoardInformation.vi" Type="VI" URL="../navX Library v2/Get/Get_BoardInformation.vi"/>
			<Item Name="Get_Connect_Status.vi" Type="VI" URL="../navX Library v2/Get/Get_Connect_Status.vi"/>
			<Item Name="Get_Displacement.vi" Type="VI" URL="../navX Library v2/Get/Get_Displacement.vi"/>
			<Item Name="Get_Error_Status.vi" Type="VI" URL="../navX Library v2/Get/Get_Error_Status.vi"/>
			<Item Name="Get_HaultStatus.vi" Type="VI" URL="../navX Library v2/Get/Get_HaultStatus.vi"/>
			<Item Name="Get_LinearAcceleration.vi" Type="VI" URL="../navX Library v2/Get/Get_LinearAcceleration.vi"/>
			<Item Name="Get_MPUTemp.vi" Type="VI" URL="../navX Library v2/Get/Get_MPUTemp.vi"/>
			<Item Name="Get_Notifier_Hault_Notifier.vi" Type="VI" URL="../navX Library v2/_Processing Loop/Get_Notifier_Hault_Notifier.vi"/>
			<Item Name="Get_Notifier_REF_Once.vi" Type="VI" URL="../navX Library v2/_Processing Loop/Get_Notifier_REF_Once.vi"/>
			<Item Name="Get_Status.vi" Type="VI" URL="../navX Library v2/Get/Get_Status.vi"/>
			<Item Name="Get_STREAM_TYPE.vi" Type="VI" URL="../navX Library v2/Get/Get_STREAM_TYPE.vi"/>
			<Item Name="Get_Timestamp.vi" Type="VI" URL="../navX Library v2/Get/Get_Timestamp.vi"/>
			...
			<Item Name="Send_Notifier.vi" Type="VI" URL="../navX Library v2/_Processing Loop/Send_Notifier.vi"/>
			<Item Name="Soft Start.vi" Type="VI" URL="../Soft Start.vi"/>
			<Item Name="toggle.vi" Type="VI" URL="../toggle.vi"/>
			<Item Name="Update Serial Stream.vi" Type="VI" URL="../navX Library v2/Set/Update Serial Stream.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/Team Titanium/Documents/LabVIEW Data/MecanumTest/Builds</Property>
